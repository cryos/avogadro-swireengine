...
namespace Avogadro {
  ...
  SWireEngine::SWireEngine(QObject *parent) : Engine(parent)
  {
  }

  SWireEngine::~SWireEngine()
  {
  }

  Engine* SWireEngine::clone() const
  {
    SWireEngine* engine = new SWireEngine(parent());
    engine->setAlias(alias());
    engine->setEnabled(isEnabled());
    return engine;
  }

  bool SWireEngine::renderOpaque(PainterDevice *pd)
  {
...
#include "swireengine.moc"

Q_EXPORT_PLUGIN2(swireengine, Avogadro::SWireEngineFactory)
